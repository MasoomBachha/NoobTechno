        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                welcome_log = (f"{html.escape(chat.title)}\n"
                               f"#PRO_OWNER_JOINED\n"
                               f"**𝙼𝚈 𝙾𝚆𝙽𝙴𝚁 𝙷𝙴𝙻𝙻𝙱𝙾𝙸_𝙰𝚃𝚄𝙻 𝙹𝚄𝚂𝚃 𝙹𝙾𝙸𝙽𝙴𝙳 𝚃𝙷𝙴 𝙲𝙷𝙰𝚃🥳...**\n"
                               f"**𝙰 𝙱𝙸𝙶 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙼𝚈 𝙾𝚆𝙽𝙴𝚁..!**")
                continue

            # Welcome Devs
            elif new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "**Whoa! A 𝙿𝚁𝙾 Team just joined!🥳🥳🥳\n Welcome Him 🥳🥳🥳**",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Hey! A pro memeber joined this chat",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Hey A Support User just joined",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "A good member just joined here",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "A very good memeber joined here",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Hello! I am **TECHNO BETA MANAGER**\n I am here to help you in managing your groups in the best way", reply_to_message_id=reply)
                continue
            ...
            if should_mute:
                ...
                if welc_mutes == "strong":
                    ...
                    message = msg.reply_text(
                        f"{new_join_mem}, click the button below to prove you're human.Jaldi yaar jaldi be Lil quick fast..!!\nYou have 120 seconds only.",
                        reply_markup=InlineKeyboardMarkup([{
                            InlineKeyboardButton(
                                text="Yes, I'm real human.",
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oooye, Sed!😣😣 My Owner left this chat..😫😢😭😭", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the #DARKCobraTeam! Bye",
                    reply_to_message_id=reply,
                )
                return
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll see around and not welcome anyone then.")

        else:
            update.effective_message.reply_text(
                "I takes commands 'on/yes' or 'off/no' only!")
