...
def afk(update: Update, context: CallbackContext):
    ...
    try:
        update.effective_message.reply_text("**{}** is now gone AFK!\nThey will meet you when they will be back online.".format(
            fname, notice))
    except BadRequest:
        pass
...
When marked as AFK, any mentions will be replied to with a message to say you're not available now!
"""
